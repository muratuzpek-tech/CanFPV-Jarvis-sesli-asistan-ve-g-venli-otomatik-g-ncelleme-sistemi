...
try:
    ...
    # Headless Linux/CI ortamlarında pyautogui importu DISPLAY/Xauthority
    # hatası verebilir. Bu durum ana uygulamanın importunu düşürmemeli;
    # yalnızca masaüstü mesajlaşma özelliği çağrıldığında açık hata verilir.
    pyautogui = None
    _PYAUTOGUI = False
