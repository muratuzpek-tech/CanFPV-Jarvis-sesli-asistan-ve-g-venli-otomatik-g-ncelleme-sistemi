...
class DashboardServer:
    ...
    def __init__(self):
        ...
        # Login hiz sinirlama - IP basina basarisiz denemeleri takip eder.
        # Keyspace (~2.2 milyar, 6 karakter) tek basina 10dk pencerede pratik
        # olarak kirilamaz, ama bu ek bir savunma katmani (savunma derinligi) -
        # bedava ve makul bir onlem.
        self._login_attempts: dict[str, list[float]] = {}
        self._LOGIN_MAX_ATTEMPTS = 10
    ...
    def _ssl_enabled() -> bool:
        key, cert = tls_paths()
        return key.exists() and cert.exists()
